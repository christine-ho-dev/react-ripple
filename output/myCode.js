...
/***/ function(module, exports, __webpack_require__) {
	...
	var gridHeight = 20;
	var gridWidth = 20;
	var initialColors = ["red", "purple", "orange", "blue", "green", "black", "brown", "pink"];
	var rippleR = 5;
	var fps = 20;
	...
	var Grid = function (_React$Component) {
	    ...
	    function Grid() {
	        ...
	        _this.ripple = _this.ripple.bind(_this);
	        return _this;
	    }
	        ...
	        value: function getAllRefs(x, y) {
	            ...
	            for (var s = 1; s <= rippleR; s++) {
	                ...
	                for (var i = xmin; i <= xmax; i++) {
	                    if (this.refs.hasOwnProperty(i + "_" + ymin)) step[i + "_" + ymin] = "";
	                    if (this.refs.hasOwnProperty(i + "_" + ymax)) step[i + "_" + ymax] = "";
	                }
	                for (i = ymin + 1; i < ymax; i++) {
	                    if (this.refs.hasOwnProperty(xmin + "_" + i)) step[xmin + "_" + i] = "";
	                    if (this.refs.hasOwnProperty(xmax + "_" + i)) step[xmax + "_" + i] = "";
	                }
	                console.log(s);
	                console.log(step);
	                allRefs.push(step);
	        ...
	        value: function getGrid() {
	            ...
	            for (var i = 0; i < gridHeight; i++) {
	                ...
	                for (var j = 0; j < gridWidth; j++) {
	                    if (this.state.color != "") color = this.state.color;else color = initialColors[(j + i) % 8];
	                    cells.push(_react2.default.createElement(Square, { key: j + ',' + i,
	                        ref: j + '_' + i,
	                        dataX: j,
	                        dataY: i,
	...
	var Square = function (_React$Component2) {
	    ...
	    function Square() {
	        ...
	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Square).call(this));
	    ...
	    _createClass(Square, [{
	        ...
	        value: function setOriginalColor() {
	            this.setState({ color: "" });
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            if (this.state.color != "") style.backgroundColor = this.state.color;else style.backgroundColor = this.state.originalColor;
	            return _react2.default.createElement("td", { onClick: this.handleClick.bind(this),
	                style: style,
	...
	Square.propTypes = {
	    gotClick: _react2.default.PropTypes.func
	};

	_reactDom2.default.render(_react2.default.createElement(Grid, null), document.getElementById('container'));
